...
import { OAuthManager }from '../../tmrowapp-contrib/integrations/utils/oauth';
import env from './env';

const manager = new OAuthManager({
  baseUrl: 'https://api.tripit.com',
  consumerKey: '2120bff9f12317bc6d07fa7af37b67c2049c86fe',
  consumerSecret: 'b771b8829ed44671f3f0d255986edae9cf0f13ae',
